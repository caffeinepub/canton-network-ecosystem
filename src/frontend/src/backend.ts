...
import type { ReferralLink as _ReferralLink, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async buatLink(arg0: string, arg1: string, arg2: string | null): Promise<ReferralLink> {
        if (this.processError) {
            try {
                const result = await this.actor.buatLink(arg0, arg1, to_candid_opt_n3(this._uploadFile, this._downloadFile, arg2));
    ...
    async updateLinkData(arg0: string, arg1: string | null, arg2: string | null): Promise<ReferralLink> {
        if (this.processError) {
            try {
                const result = await this.actor.updateLinkData(arg0, to_candid_opt_n3(this._uploadFile, this._downloadFile, arg1), to_candid_opt_n3(this._uploadFile, this._downloadFile, arg2));
                return from_candid_ReferralLink_n4(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_ReferralLink>): Array<ReferralLink> {
